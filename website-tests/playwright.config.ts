...
export default defineConfig({
  ...
  projects: [
    ...
    { name: 'mobil-android',   use: { ...devices['Pixel 7'] } },
    { name: 'tablet-hoch',     use: { ...devices['iPad Mini'] } },
    { name: 'tablet-quer',     use: { ...devices['iPad Pro 11 landscape'] } },
    { name: 'desktop-klein',   use: { ...devices['Desktop Chrome'], viewport: { width: 1366, height: 768 } } },
    { name: 'desktop-gross',   use: { ...devices['Desktop Chrome'], viewport: { width: 1920, height: 1080 } } },
